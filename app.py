...
# Agora o usuário está logado. Podemos acessar suas informações.
usuario = st.session_state.usuario
email = st.session_state.usuario_email
nivel = len(usuario["bilhetes"]) // 5 + 1

# A partir daqui, tudo continua como no último código que te enviei — com layout reformulado,
# seções visuais, separadores e destaque no botão de sorteio.
